...
## task_015（G5 記録の確定・クローズ）

### 決まったこと

- task_015 は実装（`2a17eb5`）と G5 round1 の反映（`d3e5368`）で完了済みなので作り直さない。
  未コミットで残っていた敵対レビュー記録 `docs/review-log/task_015.json`（round 1・
  **merge-review: reject**・有効票 2 / 欠票 0 / 実効 high 1）と run-log をコミットして閉じた。
- round1 の 7 件は `d3e5368` で全件処理済み（high の「氏名非共有の行を個別リンクなしで claim
  できた」を含む）。規約どおり**再レビューはしない**。HEAD `8f04f0a` で verify_commands 5 本を
  `scripts/record-run.sh task_015` 経由で再実行し全て exit 0。ソースの追加変更は無い。

### 未解決

- C-015-1〜7（`docs/concerns/task_015.md`）。deferred は C-015-4（レート制限 429 の実測 →
  task_024 / task_035）と C-015-7（Hyperdrive 実測 → task_035）、C-015-5（`/api/e/*` の
  Route Handler 実行テスト → task_022 の E2E）。
- ハーネス: `.locks/run-log/task_015.lock` が前ワークフローの中断で残り、`record-run.sh` が
...
- 2026-09-24T16:46:40Z HEAD=8f04f0a 決まったこと: task_017: 最終 HEAD での verify_commands 再実行ログ（6 本とも exit 0） / 未解決: 未コミット 9 件: docs/HANDOFF.md docs/PROGRESS.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/review-log/task_015.json 
- 2026-09-24T16:46:51Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 7 件: docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/review-log/task_015.json tests/gates/probe.test.ts 
- 2026-09-24T16:47:39Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 7 件: docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/review-log/task_015.json tests/gates/probe.test.ts 
- 2026-09-24T16:48:41Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 8 件: docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/review-log/task_015.json tests/gates/probe.test.ts 
- 2026-09-24T16:51:39Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 8 件: docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/review-log/task_015.json tests/gates/probe.test.ts 
- 2026-09-24T16:53:28Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 12 件: docs/HANDOFF.md docs/PROGRESS.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/task-list.json 
- 2026-09-24T16:53:47Z HEAD=692f24d 決まったこと: task_017(引き継ぎ・確認): 最終 HEAD での verify 再実行ログと確認結果を記録する / 未解決: 未コミット 12 件: docs/HANDOFF.md docs/PROGRESS.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/task-list.json 
- 2026-09-24T16:54:39Z HEAD=61b18a1 決まったこと: task_019: BLOCKED — 依存タスク task_018 が未着手のため ConformanceKit を実装できない / 未解決: 未コミット 7 件: docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_017.json docs/review-log/task_015.json tests/gates/probe.test.ts 
...
- 2026-09-24T18:21:09Z HEAD=eb7a373 決まったこと: task_021: 管理面（別IdP・二人承認・lookup/anonymize/suspend）・O-9〜O-13・CSV・法務文書・ランブック10本・悪用対策 / 未解決: 未コミット 24 件: docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json docs/run-log/task_018.json docs/run-log/task_019.json 
- 2026-09-24T18:22:25Z HEAD=eb7a373 決まったこと: task_021: 管理面（別IdP・二人承認・lookup/anonymize/suspend）・O-9〜O-13・CSV・法務文書・ランブック10本・悪用対策 / 未解決: 未コミット 27 件: docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json docs/run-log/task_018.json 
...
- 2026-09-24T19:36:12Z HEAD=9f56ddb 決まったこと: task_023(修正ラウンド): ADR-007 の PO ゲート差し戻しとレビューギャップ2件を解消 / 未解決: 未コミット 20 件: .github/workflows/gate.yml docs/metrics/weekly-2026-09-21.json docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json 
- 2026-09-24T19:41:39Z HEAD=9f56ddb 決まったこと: task_023(修正ラウンド): ADR-007 の PO ゲート差し戻しとレビューギャップ2件を解消 / 未解決: 未コミット 26 件: .github/workflows/gate.yml docs/HANDOFF.md docs/acceptance-checks.json docs/concerns/task_022.md docs/metrics/weekly-2026-09-21.json docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json 
- 2026-09-24T19:42:28Z HEAD=9f56ddb 決まったこと: task_023(修正ラウンド): ADR-007 の PO ゲート差し戻しとレビューギャップ2件を解消 / 未解決: 未コミット 26 件: .github/workflows/gate.yml docs/HANDOFF.md docs/acceptance-checks.json docs/concerns/task_022.md docs/metrics/weekly-2026-09-21.json docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json 
- 2026-09-24T19:44:31Z HEAD=9f56ddb 決まったこと: task_023(修正ラウンド): ADR-007 の PO ゲート差し戻しとレビューギャップ2件を解消 / 未解決: 未コミット 28 件: .github/workflows/gate.yml docs/HANDOFF.md docs/PROGRESS.md docs/acceptance-checks.json docs/concerns/task_022.md docs/metrics/weekly-2026-09-21.json docs/run-log/task_008.json docs/run-log/task_012.json 
- 2026-09-24T19:46:31Z HEAD=fccccf8 決まったこと: task_022(修正ラウンド): 敵対レビュー6件是正・検証失敗の切り分け・台帳同期 / 未解決: 未コミット 15 件: .github/workflows/gate.yml docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json docs/run-log/task_018.json 
- 2026-09-24T19:47:33Z HEAD=fccccf8 決まったこと: task_022(修正ラウンド): 敵対レビュー6件是正・検証失敗の切り分け・台帳同期 / 未解決: 未コミット 16 件: .github/workflows/gate.yml docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json 
- 2026-09-24T19:50:31Z HEAD=fccccf8 決まったこと: task_022(修正ラウンド): 敵対レビュー6件是正・検証失敗の切り分け・台帳同期 / 未解決: 未コミット 17 件: .github/workflows/gate.yml docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json 
- 2026-09-24T19:56:37Z HEAD=fccccf8 決まったこと: task_022(修正ラウンド): 敵対レビュー6件是正・検証失敗の切り分け・台帳同期 / 未解決: 未コミット 17 件: .github/workflows/gate.yml docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json docs/run-log/task_017.json 
- 2026-09-24T19:57:46Z HEAD=fccccf8 決まったこと: task_022(修正ラウンド): 敵対レビュー6件是正・検証失敗の切り分け・台帳同期 / 未解決: 未コミット 16 件: .github/workflows/gate.yml .gitignore docs/HANDOFF.md docs/run-log/task_008.json docs/run-log/task_012.json docs/run-log/task_014.json docs/run-log/task_015.json docs/run-log/task_016.json 
