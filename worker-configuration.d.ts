/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3e7791df6a0a10050c023d30c1b44115)
...
interface __BaseEnv_Env {
	...
	WORKER_SELF_REFERENCE: Fetcher /* cashapp-staging */ | Fetcher /* cashapp-production */ | Service<typeof import("./.open-next/worker").default>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "staging";
		WORKER_SELF_REFERENCE: Fetcher /* cashapp-staging */;
	}
	interface ProductionEnv {
		HYPERDRIVE: Hyperdrive;
		ASSETS: Fetcher;
		APP_ENV: "production";
		WORKER_SELF_REFERENCE: Fetcher /* cashapp-production */;
	}
